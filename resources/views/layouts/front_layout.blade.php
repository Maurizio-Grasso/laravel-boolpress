...
<body class="body body--front">
    ...
    <div class="container-xl outer-wrapper">

        <div class="row no-gutters">
            <div class="col no-gutters">

                @include('layouts.partials.header-front')
        ...
        <div class="row no-gutters page-content">
            ...
            <div class="col-lg-3 no-gutters">
                ...
                @include('layouts.partials.sidebar-front')
        ...
        <div class="row no-gutters">            
            <div class="col no-gutters">
                ...
                <footer class="footer--front">
                    Made with <i class="far fa-heart"></i> in Boolean
                </footer>
